...
export default function Navbar() {
  ...
  // Listen for external open-location requests (e.g. from SmartRecommendations)
  useEffect(() => {
  ...
  // Request push notification permission once user logs in
  useEffect(() => {
    if (user) {
      // Small delay so it doesn't fire immediately on page load
      const t = setTimeout(() => requestPushPermission(), 3000);
          ...
          <div className="max-w-7xl mx-auto px-3 md:px-6">
            <div className="flex items-center gap-2 md:gap-4 h-14 md:h-16">
              ...
              <div className="flex items-center gap-0.5 shrink-0">
                ...
                <Link href="/cart" className="relative p-2 rounded-xl cursorhover:bg-gray-50 transition group" aria-label="Cart">
