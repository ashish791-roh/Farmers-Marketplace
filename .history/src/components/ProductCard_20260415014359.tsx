...
const ProductCard = ({ id, name, price, image }: Props) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition p-3">
      ...
      <div className="mt-3">
        <h3 className="text-sm font-semibold text-gray-800 hover:scale-105 transition duration-300 shadow-sm → hover:shadow-xl">
          {name}
        </h3>

        <p className="text-green-600 font-bold mt-1 hover:scale-105 transition duration-300 shadow-sm → hover:shadow-xl">
          ₹{price}
        </p>
