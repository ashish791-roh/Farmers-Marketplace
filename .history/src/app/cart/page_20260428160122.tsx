...
function CartItem({
  ...
  const savings = originalPrice && originalPrice > item.price ? originalPrice - item.price : 0;
...
// ── Price Breakdown ────────────────────────────────────────────────────────────
function PriceBreakdown({ cart, couponDiscount = 0 }: { cart: CartItem[]; couponDiscount?: number }) {
