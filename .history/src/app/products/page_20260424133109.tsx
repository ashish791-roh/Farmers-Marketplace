...
type ProductsMetaProps = {
  searchParams: Promise<{ category?: string; search?: string }>;
};

export async function generateMetadata({ searchParams }: ProductsMetaProps): Promise<Metadata> {
  ...
  return {
    ...
    description: "Browse all fresh farm products on FarmX — vegetables, fruits, dairy, grains and more. Sourced directly from verified farmers.",
    openGraph: {
      title: "All Products | FarmX",
      description: "Browse all fresh farm products — sourced directly from verified farmers.",
    },
  };
}
